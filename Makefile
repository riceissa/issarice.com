...
PANDOC_FLAGS = -f markdown+smart -t html5 --shift-heading-level-by=1 --template=templates/default.html5 --include-in-header css/solarized_light.css -M today:$(shell date -Idate | tr -d '\n')
