...
The following table tracks my online presence.

As with software, I like to sign up for a lot of online services to
try them out, even though I know I won't continue using most of them.

I usually use "riceissa" on most sites. This is a historical accident:
when I tried to sign up for my Gmail account, "issarice" was already
taken, so I picked "riceissa" instead. Since then, I've sort of
standardized on "riceissa" for most services, although I also use
"issarice".

The "current activity" column describes how much I use the service now
(the past six months, say). The numbers mean:

- 0: No activity or close to no activity (not even signed in, hardly
  check the site).
- 1: Use around once per month.
- 2: More than once per week.

The "total activity" column describes how much I have used the service
across all time. The numbers mean:

- 0: No activity or close to no activity.
- 1: A small to moderate amount of activity.
- 2: More than a moderate amount of activity.

For activity columns, the first number is "as consumer" and the second
is "as producer".

Regarding "forecasting" as a subject area versus "prediction" as a service type, at the moment they seem identical, but e.g. if a wiki about forecasting emerged, it would have a "forecasting" subject area but a "wiki" service type.

The "sphere" column says something about my motivation for caring about the service or how I came to know about the service in the first place. For instance, the Machine Learning Subwiki has "Vipul Naik" as its sphere rather than "Technology" because my account creation on that wiki was a direct result of being in contact with Vipul Naik rather than my general interest in technology.

The "EA/R" sphere refers to the effective altruism and rationality communities.

With JavaScript enabled, it is possible to sort the table by each column.

If you like tables like these, you might enjoy looking at the [contract work I've done for Vipul Naik](https://contractwork.vipulnaik.com/worker.php?worker=Issa+Rice).

|Service|Account name|Subject area|Sphere|Service type|Join date|Current activity (as consumer)|Current activity (as producer)|Total activity (as consumer)|Total activity (as producer)|Notes|
|-------|------------|------------|------|------------|---------|-----------------------------:|-----------------------------:|---------------------------:|---------------------------:|-----|
|[Personal website](https://www.linode.com/)|[issarice.com](https://issarice.com)|Various|Mainstream|Static website|2014-09-14|1|2|2|2|This is my personal website. The service column link goes to Linode, which hosts the site.|
|[Gmail](https://mail.google.com)|[riceissa](mailto:riceissa@gmail.com)|Various|Mainstream|Email|2010-10-19|2|2|2|2|This is my primary email address.|
|[Facebook](https://www.facebook.com/)|[riceissa](https://www.facebook.com/riceissa)|Various|Mainstream|Social media|2014-03-29|2|0|2|2|This is the primary social networking service I use. I check Facebook a couple of times each day. I generally accept all friend requests that don't appear to be spam; having some mutual friends or messaging me simultaneously with your friend request will let me know that your profile is genuine.|
|[Messenger](https://www.messenger.com)|[riceissa](https://www.messenger.com/t/riceissa)|Various|Mainstream|Messaging|2014-03-29|2|2|2|2|This account is technically tied to my Facebook account. These days I have Messenger open all the time while I work, and only periodically check Facebook.|
|[GitHub](https://github.com/)|[riceissa](https://github.com/riceissa/)|Programming|Technology|Code repository|2012-02-18|2|2|2|2|My primary code (and other work) repository. GitHub also has a pastebin service called Gist, which I use. You can see my [public gists](https://gist.github.com/riceissa).|
|[Timelines Wiki](https://timelines.issarice.com/wiki/Main_Page)|[Issa](https://timelines.issarice.com/wiki/User:Issa)|Various|Vipul Naik|Wiki|2017-03-12|2|2|2|2|I host this site. The site was created after Vipul Naik's paid editing project on the English Wikipedia was shut down.|
|[Cause Prioritization Wiki](https://causeprioritization.org/)|[Issa Rice](https://causeprioritization.org/_activity?forUser=Issa%20Rice)|Altruism|EA/R|Wiki|2014-11-28|1|1|2|2|I host this wiki. I originally used "[issa](https://causeprioritization.org/_activity?forUser=issa)" as my account, but gitit, the software that runs the wiki, uses the committer name (in my case, "Issa Rice", as I have Git configured to use my real name) as the account name for offline edits. Seeing this, I decided to start using "Issa Rice" for online edits as well, but continued using the "issa" account as well.|
|[Content Creation Wiki](http://contentcreation.issarice.com/)|[riceissa](https://github.com/riceissa/contentcreation/commits?author=riceissa)|Content creation|Vipul Naik|Wiki|2017-07-02|1|2|1|2|I am the maintainer of this wiki. The wiki is hosted through GitHub Pages so technically the account is the same as my GitHub account.|
|[Quora](https://www.quora.com/)|[Issa-Rice](https://www.quora.com/Issa-Rice)|Various|Mainstream|Question and answer|2014-01-01|2|1|2|2|It looks like I joined right after contacting Cognito Mentoring, possibly even to read the Quora answers Cognito Mentoring linked to me. The date is the earliest email I have from Quora, so it is possible I joined a little earlier. I followed my first question on February 20, 2014.|
|[LessWrong](http://lesswrong.com/)|[riceissa](http://lesswrong.com/user/riceissa/overview/)|Rationality|EA/R|Discussion|2012-07-10|1|0|2|1|The join date is my best guess based on public activity. The first mention of LessWrong in my email record is from 2011-10-29.|
|[LessWrong Wiki](https://wiki.lesswrong.com/wiki/LessWrong_Wiki)|[Riceissa](https://wiki.lesswrong.com/wiki/Special:Contributions/Riceissa)|Rationality|EA/R|Wiki|2013-02-15|2|0|2|0||
|[Effective Altruism Forum](http://effective-altruism.com/)|[riceissa](http://effective-altruism.com/user/riceissa/)|Altruism|EA/R|Discussion|2014-09-10|2|0|2|1||
...
|[Cognito Mentoring Wiki](https://info.cognitomentoring.org/wiki/Main_Page)|[Riceissa](https://info.cognitomentoring.org/wiki/User:Riceissa)|Mentoring|Vipul Naik|Wiki|2014-09-12|||||This wiki was created by Vipul Naik and Jonah Sinick.|
